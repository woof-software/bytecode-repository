...
This factory contract deploys Compound InstitutionalComet implementations with version control and timelock governance integration for secure protocol upgrades.
...
The contract type deployed by this factory: InstitutionalComet.
...
New version must be released._
...
Deploys a new InstitutionalComet implementation with the current version.
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| config | struct Configuration | constructor argumets for the InstitutionalComet. |

#### Return Values

| Name | Type | Description |
| ---- | ---- | ----------- |
| [0] | address | Address of the newly deployed InstitutionalComet implementation. |
