 ...
 */
contract CometFactoryV2LiveTest is BaseFactory, ICometFactoryV2 {
    /// @notice The contract type deployed by this factory: CometLiveTest.
    bytes32 public constant COMET_CT = "CometLiveTest";
    ...
    /// @dev If the major version changes, it must equal the previous major version + 1.
